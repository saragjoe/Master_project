...
ibcao_file = "C:/Users/sarag/OneDrive/Skrivebord/MASTER/Data/ibcao_v5_2024_100m_depth_isfjorddrena_area_bathymetry_data.csv"
...
def plot_stations_and_bathymetry(unis_data, bath_data):
    ...
    ax.set_extent([8, 14, 77.55, 78.15], crs=ccrs.PlateCarree())
